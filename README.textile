**This repository is more or less frozen. I've rewritten test unit to be much simpler, and more featureful and that github project is https://github.com/rocky/emacs-test-simple**
